...
class BookControllerTest {
    ...
    void addBook() throws Exception{
        book = new BookDTO(1,"Dangerous pleasure","CJ Paris",
                "Story about cheating to fiance",2015);
    ...
    void getBookByName() throws Exception{
        when(bookService.findBookByName("Monster")).thenReturn(
                new BookDTO(1,"Monster", "Christopher Pike",
                        "Alien Monsters",1994)
        );

        mockMvc.perform(MockMvcRequestBuilders.get("/book/getbyname/{bookName}"
                        ,"Monster")
                ...
                .andExpect(MockMvcResultMatchers
                        .jsonPath("$.authorName").value("Christopher Pike"));
